...
public class GraphDeceased extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_deceased);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = len-31; i < len; i++) {
                                ...
                                String dcon = casetime.getString("dailydeceased");
    ...
    public void Visualize(ArrayList<DataEntry> c){
        ...
        cartesian.yAxis(0).title("Patients Deceased");
    ...
    private class DataStructure extends ValueDataEntry {
